const LayoutTest = () => {
  // taken and modified from https://github.com/cbracco/html5-test-page
return (<main>
    <header role="banner">
      <h1>Test page</h1>
    </header>
      ...
      <main role="main">
        <section id="text">
          ...
          <article id="text__headings">
            <article>
              <h1>Heading 1 nest</h1>
              <article>
                <h1>Heading 1, 2 nest</h1>
              </article>
            </article>
            <header>
              <h1>Headings</h1>
          ...
          <article id="text__lists">
            ...
            <div>
              ...
              <h3>Unordered List</h3>
              <ul>
                <li className="bulletted">List Item 1</li>
                <li className="bulletted">List Item 2</li>
                <li className="bulletted">List Item 3</li>
              </ul>
            </div>
            <footer><p><a href="#top">[Top]</a></p></footer>
          </article>
          ...
          <form>
            ...
            <fieldset id="forms__checkbox">
              ...
              <ul className="list list--bare">
                <li><label htmlFor="checkbox1"><input id="checkbox1" name="checkbox" type="checkbox" checked /> Choice A</label></li>
            ...
            <fieldset id="forms__radio">
              ...
              <ul className="list list--bare">
                <li><label htmlFor="radio1"><input id="radio1" name="radio" type="radio" className="radio" checked /> Option 1</label></li>
            ...
            <div>
              <iframe src="https://google.com" height="300"></iframe></div>
            <footer><p>
